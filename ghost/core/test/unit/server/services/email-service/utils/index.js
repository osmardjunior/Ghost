...
exports.sleep = exports.createPrometheusClient = exports.createDb = exports.createModelClass = exports.createModel = void 0;
const bson_objectid_1 = __importDefault(require("bson-objectid"));
const sinon_1 = __importDefault(require("sinon"));
const createModel = (propertiesAndRelations) => {
    const id = propertiesAndRelations.id ?? (0, bson_objectid_1.default)().toHexString();
    return {
        id,
...
const createModelClass = (options = {}) => {
    return {
        ...
        findOne: async (data, o) => {
            ...
            return Promise.resolve(createModel({ ...options.findOne, ...data }));
        },
        findAll: async (data) => {
...
const createDb = ({ first, all } = {}) => {
    ...
    const db = {
        ...
        update: sinon_1.default.stub().resolves(),
        orderByRaw: function () {
            return this;
        },
        insert: function () {
...
const createPrometheusClient = ({ registerCounterStub, getMetricStub, incStub } = {}) => {
    return {
        registerCounter: registerCounterStub ?? sinon_1.default.stub(),
        getMetric: getMetricStub ?? sinon_1.default.stub().returns({
            inc: incStub ?? sinon_1.default.stub()
        })
    };
};
exports.createPrometheusClient = createPrometheusClient;
const sleep = (ms) => {
