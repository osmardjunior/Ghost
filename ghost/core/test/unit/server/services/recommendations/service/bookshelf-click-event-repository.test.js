...
describe('BookshelfClickEventRepository', function () {
    ...
    it('toPrimitive', async function () {
        const repository = new service_1.BookshelfClickEventRepository({}, {
            sentry: undefined
        });
        strict_1.default.deepEqual(repository.toPrimitive(service_1.ClickEvent.create({
            id: 'id',
    ...
    it('modelToEntity', async function () {
        ...
        strict_1.default.deepEqual(entity, service_1.ClickEvent.create({
            id: 'id',
            recommendationId: 'recommendationId',
            memberId: 'memberId',
            createdAt: new Date('2021-01-01')
    ...
    it('modelToEntity returns null on errors', async function () {
        ...
        sinon_1.default.stub(service_1.ClickEvent, 'create').throws(new Error('test'));
        const entity = repository.modelToEntity({
            id: 'id',
            get: (key) => {
                return {
